$(function() {
    ...
    function g(n) {
	   ...
	   var n = '<iframe class="J_iframe"  width="100%" height="100%" src="' + dataId + '" frameborder="0" data-id="' + dataId + '" seamless></iframe>';
       $(".J_mainContent").find("iframe.J_iframe").each(function(){
    	   $(this).remove();
       })
    ...
    function h() {
        ...
        if ($(this).parents(".J_menuTab").hasClass("active")) {
            ...
            if ($(this).parents(".J_menuTab").prev(".J_menuTab").size()) {
                ...
                var tabNode=$(this).parents(".J_menuTab").prev(".J_menuTab:last");
                tabNode.addClass("active");
                var dataId=tabNode.attr("data-id");
                var n = '<iframe class="J_iframe"  width="100%" height="100%" src="' + dataId + '" frameborder="0" data-id="' + dataId + '" seamless></iframe>';
                $(".J_mainContent").append(n);
                $(".J_mainContent .J_iframe").each(function() {
                    if ($(this).data("id") == k) {
    ...
    function() {
        ...
        var n = '<iframe class="J_iframe"  width="100%" height="100%" src="tohome" frameborder="0" data-id="tohome" seamless></iframe>';
        $(".J_mainContent").append(n);
    })
