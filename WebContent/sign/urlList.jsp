...
<c:if test="${sessionScope.auser.utype == 1 }">
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li><a href="${basePath}/roomList.do"><i class="fa fa-home"></i> <span>岗位信息管理</span></a></li>
                <li><a href="${basePath}/clazzList.do"><i class="fa fa-glass"></i> <span>招聘信息管理</span></a></li>
            </ul>
            </c:if>
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li><a href="${basePath}/qiyeInfo.do?uid=${sessionScope.auser.uid}"><i class="fa fa-comments"></i> <span>公司信息</span></a></li>
                <li><a href="${basePath}/infoManage.do?type=2"><i class="fa fa-home"></i> <span>查看学生信息</span></a></li>
            </ul>
            </c:if>
